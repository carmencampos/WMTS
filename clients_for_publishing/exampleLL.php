...
<div class="howto">
<p><a href="../tilemill.php" title="tillemill init">How to create this?</a></p>
</div>
...
//var mbTiles = new L.tileLayer('readmbtiles.py?db=example.mbtiles&z={z}&x={x}&y={y}', {
var mbTiles = new L.tileLayer('readmbtiles.py?db=example.mbtiles&z=3&x=1&y=1', {
